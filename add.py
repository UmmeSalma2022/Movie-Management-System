...
if __name__=="__main__":
    ...
    label1=Label(root,text="Movie Name:")
    label1.place(x=300,y=120)

    label2=Label(root,text="Movie No :")
    label2.place(x=300,y=170)

    label3=Label(root,text="Release date:")
    label3.place(x=300,y=220)

    label4=Label(root,text="Budget:")
    label4.place(x=300,y=270)

    label5=Label(root,text="Genere :")
    label5.place(x=300,y=320)

    label6=Label(root,text="Actor Name :")
    ...
    b4=Button(root,text="Submit",command=add_patient,activebackground="green",bg="#68BBE3",width=30)
    b4.place(x=363,y=420)
    b3=Button(root,text="Back",command=clse,bg="#68BBE3",activebackground="blue",width=30)
