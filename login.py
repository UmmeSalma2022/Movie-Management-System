...
def pos():
    ...
    if ret==0:
        ...
        for i in lines:
            ...
            messagebox.showwarning("Warning","Director id or password is incorrect.")
    else:
        messagebox.showwarning("Warning","Type Director id and password.")
def verifier():
    a=b=0
    if not eid.get():
        a=1
...
if __name__=="__main__":
    ...
    label1=Label(root,text="Director id :")
    ...
    b4=Button(root,text="Submit",command=pos,activebackground="grey",bg="#85929E",width=30)
    b4.place(x=363,y=200)
    b3=Button(root,text="Close",command=clse,bg="#85929E",activebackground="red",width=30)
